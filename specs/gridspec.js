...
describe('Grid', function() {
  ...
  it('can solve the puzzle from the readme', function() {
    grid.loadPuzzle("53..7....6..195....98....6.8...6...34..8.3..17...2...6.6....28....419..5....8..79");
    grid.solve();
    expect(grid.printSolution()).to.equal("534678912672195348198342567859761423426853791713924856961537284287419635345286179");
  });
});
